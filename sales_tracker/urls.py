...
salesTrackerRouter.register(r"sales-tracker/store",viewset=views.StoreViewSet,basename="sales-tracker")
...
salesTrackerRouter.register(r"sales-tracker/user-shopify-store",viewset=views.UserShopifyStoreViewSet,basename='user-shopify-store')